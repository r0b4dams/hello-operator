...
const helloworldFinalizer = "demo.example.com/finalizer"
...
func (r *HelloWorldReconciler) doFinalizerOperationsForHelloWorld(cr *demov1.HelloWorld) {
...
func (r *HelloWorldReconciler) deploymentForHelloWorld(
	helloworld *demov1.HelloWorld) (*appsv1.Deployment, error) {
