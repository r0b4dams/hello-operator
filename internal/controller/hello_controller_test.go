...
var _ = Describe("Hello controller", func() {
	Context("Hello controller test", func() {
		...
		AfterEach(func() {
			By("removing the custom resource for the Kind Hello")
			found := &demov1alpha1.Hello{}
		...
		It("should successfully reconcile a custom resource for Hello", func() {
			...
			Eventually(func() error {
				if hello.Status.Conditions != nil &&
					len(hello.Status.Conditions) != 0 {
